...
// as Julia's ccall. Implemented by cclipper2.cpp (built by Clipper2_jll as
// libcclipper2, with USINGZ, linked against libClipper2Z).
//
...
//   - When compiled with Clipper2's USINGZ vertex mode: every vertex carries
//     a third int64 z. The narrow CPoint64 entry points set z = 0 internally;
//     the *_z entry points expose it for vertex tagging/provenance.
//     (A non-USINGZ build lacks the *_z symbols.)
//
